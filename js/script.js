...
function showAboutIntroductionTexts() {
  if (!aboutSectionEntered) {
    new Typed("#work", {
      strings: [
        "Currently A Student @ <span class = 'color-primary'>Faith Lutheran High School</span>",
      ],
      typeSpeed: 20,
      loop: false,
      startDelay: 0,
      ...
      onComplete: function () {
        new Typed(".office-text", {
          strings: [
            "Devoting Hours Into The ChampionAI App.",
          ],
          typeSpeed: 50,
          loop: false,
          startDelay: 0,
          ...
          onComplete: function () {
            new Typed(".spare-text", {
              strings: [
                "In My Spare Time, I <span class = 'color-primary'>Develop</span> And <span class = 'color-primary'>Explore</span> New Technologies.",
              ],
              typeSpeed: 50,
              loop: false,
              startDelay: 0,
              ...
              onComplete: function () {
                new Typed(".language-text", {
                  strings: [
                    "I Program In Python, Javascript, HTML, CSS, Bash, And C++",
                  ],
                  typeSpeed: 50,
                  loop: false,
                  startDelay: 0,
                  ...
                  onComplete: function () {
                    new Typed(".hobby-text", {
                      strings: [
                        "I <span class = 'color-primary'>Love</span> To Talk About <span class = 'color-primary'>School</span>, <span class = 'color-primary'>STEM</span> And <span class = 'color-primary'>Life</span>.",
                      ],
                      typeSpeed: 50,
                      loop: false,
                      startDelay: 0,
                        ...
                        new Typed(".game-text", {
                          ...
                          onComplete: function () {
                            new Typed(".contribution-text", {
                              strings: [
                                "Follow Me On <a href='https://www.instagram.com/joe.cool8/' target='_blank'><span class = 'color-palatte-4'> Instagram</span></a> To Get To Know Me Better.",
                              ],
                              typeSpeed: 30,
                              loop: false,
                              startDelay: 0,
                              ...
                              onComplete: function () {
                                new Typed(".motto", {
                                  strings: [
                                    "My Ultimate Goal Is To Make The World A Better Place.",
                                  ],
                                  typeSpeed: 50,
                                  loop: false,
                                  startDelay: 0,
